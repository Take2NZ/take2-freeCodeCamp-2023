...
You should have an `img` element with an `src` value of `http://localhost:8000/images/cat-photo-app/relaxing-cat.jpg`. You may have accidentally deleted it.

```js
assert(
  document.querySelector('img') &&
    document.querySelector('img').getAttribute('src') ===
      'http://localhost:8000/images/cat-photo-app/relaxing-cat.jpg'
);
```
